...
def main():
    parser = build_arg_parser("Run a single experiment on Give Me Some Credit.")
    ...
    output_path = (
        Path(args.output) if args.output else TABLES_DIR / f"gmsc_{args.split}_seed{args.seed}.csv"
    )
